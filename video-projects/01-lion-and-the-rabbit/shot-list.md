...
|---|------|------|--------------|
| 1 | Hook | Parrot mascot on branch, addressing camera, warm expression | Mascot reference image (generate first, reuse) |
...
| 7 | Moral | Parrot mascot again, same reference as shot 1 | Reuse mascot reference |
