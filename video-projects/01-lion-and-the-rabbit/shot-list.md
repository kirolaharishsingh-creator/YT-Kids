...
|---|------|------|--------------|
| 1 | Hook | Myna mascot on branch, addressing camera, warm expression | Mascot reference image (generate first, reuse) |
...
| 7 | Moral | Myna mascot again, same reference as shot 1 | Reuse mascot reference |
